...
| Codex / Grok Build       | Optional subscription authentication and explanations | See [provider notes](docs/providers.md); clients are separately installed and not redistributed                   |
