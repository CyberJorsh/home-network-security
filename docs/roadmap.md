...
| Optional subscription AI | Exact editable/redacted summary, manual provider workflow     | Supported embedded ChatGPT + Grok login/inference with summary-only containment and no paid fallback    |
