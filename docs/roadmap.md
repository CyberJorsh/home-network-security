...
| Optional subscription AI | Official-client login, editable/redacted summary, manual inference | Complete account acceptance on both platforms; embedded inference with summary-only containment and no paid fallback |
